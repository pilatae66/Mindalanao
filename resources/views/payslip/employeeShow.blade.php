        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-white">
                    <a href="{{ route('print.payslip', $payslip->id) }}" class="btn tx-primary bg-white btn-rounded float-right" data-toggle="tooltip" data-placement="top" title="Print Payslip'">
                    ...
                    <div class="d-flex justify-content-between align-items-center my-3">
                        ...
                        <div class="wd-40p bd pd-10">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>₱{{ number_format($payslip->user->position[0]->salary,2, '.', ',') }}</div>
                            </div>
                        </div>
                    </div><!-- end row -->
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="wd-40p">
                            <div class="card bd-0">
                                ...
                                <div class="card-body bd bd-t-0">
                                    <div class="d-flex justify-content-between">
                                        <div>Days Work</div>
                                        <div>{{ number_format($payslip->user->dtrDataEmployee(Carbon\Carbon::now()->month, Carbon\Carbon::now()->year, Carbon\Carbon::now()->day)['total_hours'], 1, '.', ',') }}</div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="tx-10">OT(No. of hours)</div>
                                        <div>{{ number_format($payslip->user->dtrDataEmployee(Carbon\Carbon::now()->month, Carbon\Carbon::now()->year, Carbon\Carbon::now()->day)['total_overtime_hours'], 1, '.', ',') }}</div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <div>HOLIDAY</div>
                                        <div>₱0.00</div>
