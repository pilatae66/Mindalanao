        ...
        <div class="col-md-12">
            <div class="card bd-0">
                <div class="card-header tx-medium bd-0 tx-white bg-primary d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('position.create') }}" class="btn btn-sm btn-primary btn-rounded">
                            <i class="icon ion-md-add"></i> Add New
                        </a>
                        <a href="{{ route('print.position') }}" class="btn btn-sm btn-primary btn-rounded" data-toggle="tooltip" data-placement="top" title="Print Position Master List'">
